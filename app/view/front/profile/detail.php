                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col">
                        <div class="card-body">
                            ...
                            <h5 class="card-text text-center"><?= $bum->username ?></h5>
                            <div class="bg-primary text-white btn-sm mb-3 text-center"><?php echo $bum->role; ?></div>
                            <div class="row text-center mb-3">
                                <div class="col">
                                    <a class="text-dark text-decoration-none" href="<?= base_url('like/index/' . $bum->id) ?>"><i class="fas fa-thumbs-up fa-lg"></i> <?php echo $bum->likecount; ?></a>
                                </div>
                                <div class="col">
                            ...
                            <?php if (isset($sess->user->id) && ($sess->user->role == 'owner' || $sess->user->role == 'admin')) { ?>
                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form id="fprofile" action="<?= base_url() ?>profile/proses_detail" method="post" enctype="multipart/form-data">
                                                <div class="row">
                                                    <input type="text" name="id" id="idi" value="<?= $bum->id ?>" hidden>
                                                    ...
                                                    <?php if (isset($sess->user->id) && ($sess->user->role == 'owner')) { ?>
                                                        <div class="col-12">
                                                    ...
                                                    <?php } else { ?>
                                                        <div class="col-12 mb-2">
                                                            <label for="irole" class="form-label" hidden>Role</label>
                                                            <select id="irole" class="form-select" name="role" hidden>
                                                                <option value="owner" <?php if ($bum->role == 'owner') echo 'selected'; ?>>Owner</option>
                                                                <option value="admin" <?php if ($bum->role == 'admin') echo 'selected'; ?>>Administrator</option>
                                                                <option value="user" <?php if ($bum->role == 'user') echo 'selected'; ?>>User</option>
                                                            </select>
